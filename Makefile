...
STANDARD_IMAGES = bare-armv7 bare-armv8 linux-s390x android-arm android-arm64 linux-x86 linux-x64 linux-arm64 linux-armv5 linux-armv6 linux-armv7 linux-mips linux-mipsel linux-ppc64le windows-x86 windows-x64
...
bare-armv8.test_ARGS = --languages C --build-systems CMake --emulator "/usr/bin/qemu-arm"
bare-armv7.test_ARGS = --languages C --build-systems CMake --emulator "/usr/bin/qemu-arm"
